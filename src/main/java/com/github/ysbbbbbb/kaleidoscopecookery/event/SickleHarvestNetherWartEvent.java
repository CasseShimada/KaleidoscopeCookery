...
public class SickleHarvestNetherWartEvent {
    public static void register() {
        ModEvents.SICKLE_HARVEST.register(SickleHarvestNetherWartEvent::onSickleHarvestNetherWart);
    }

    private static void onSickleHarvestNetherWart(SickleHarvestEvent event) {
