...
public class ExtraLootTableDrop {
    ...
    private static final Identifier ZOGLIN = Identifier.fromNamespaceAndPath("minecraft", "entities/zoglin");
    private static final Identifier ZOMBIFIED_PIGLIN = Identifier.fromNamespaceAndPath("minecraft", "entities/zombified_piglin");
    ...
    public static void register() {
        LootTableEvents.MODIFY.register((key, tableBuilder, source, wrapperLookup) -> {
            ...
            if (id.equals(HOGLIN)) {
                ...
                addOilDrop(tableBuilder, 2, wrapperLookup);
            } else if (id.equals(ZOGLIN)) {
                addOilDrop(tableBuilder, 2, wrapperLookup);
            } else if (id.equals(ZOMBIFIED_PIGLIN)) {
                addOilDrop(tableBuilder, 1, wrapperLookup);
