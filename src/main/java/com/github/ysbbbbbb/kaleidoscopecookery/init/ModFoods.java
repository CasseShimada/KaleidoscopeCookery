...
public interface ModFoods {
    ...
    // 热干面
    FoodProperties HOT_DRY_NOODLES = (builder())
            .nutrition(14).saturationModifier(0.643f)
            .effect(new MobEffectInstance(VITALITY, 8 * 60 * 20), 1.0F)
            .alwaysEdible().build();

    // 腊八粥
    FoodProperties LABA_CONGEE = (builder())
