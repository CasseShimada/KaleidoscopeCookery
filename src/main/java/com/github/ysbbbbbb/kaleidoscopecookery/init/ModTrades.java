...
public class ModTrades {
    public static void registerTrades() {
        // 注册厨师村民的交易
        TradeOfferHelper.registerVillagerOffers(ModVillager.CHEF_KEY, 1, ModTrades::addNoviceTrades);
        TradeOfferHelper.registerVillagerOffers(ModVillager.CHEF_KEY, 2, ModTrades::addApprenticeTrades);
        TradeOfferHelper.registerVillagerOffers(ModVillager.CHEF_KEY, 3, ModTrades::addJourneymanTrades);
        TradeOfferHelper.registerVillagerOffers(ModVillager.CHEF_KEY, 4, ModTrades::addExpertTrades);
        TradeOfferHelper.registerVillagerOffers(ModVillager.CHEF_KEY, 5, ModTrades::addMasterTrades);
    }
    ...
    private static VillagerTrades.ItemListing createRecipeTrade(Item input, int inputCount, RecipeItem.RecipeRecord record,
        ...
        return (level, trader, random) -> new MerchantOffer(inputStack, outputStack, maxTrades, xp, priceMultiplier);
    }
