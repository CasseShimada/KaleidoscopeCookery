...
public record MillstoneBindableData(int rotSpeedTick, float liftAngle, Vec3 offset) {
    private static final Codec<MillstoneBindableData> DATA_CODEC = RecordCodecBuilder.create(instance -> instance.group(
            Codec.intRange(1, Integer.MAX_VALUE).fieldOf("rot_speed_tick").forGetter(MillstoneBindableData::rotSpeedTick),
    ...
    private static final Codec<EntityType<?>> ENTITY_TYPE_CODEC = Identifier.CODEC.comapFlatMap(id ->
            BuiltInRegistries.ENTITY_TYPE.get(id)
                    ...
                    .orElseGet(() -> DataResult.error(() -> "Unknown entity type: " + id)),
