...
public record StockpotVisuals(
    ...
    public static final StockpotVisuals DEFAULT = new StockpotVisuals(
            DEFAULT_COOKING_TEXTURE,
            DEFAULT_FINISHED_TEXTURE,
            DEFAULT_COOKING_BUBBLE_COLOR,
            DEFAULT_FINISHED_BUBBLE_COLOR
    );

    public static StockpotVisuals from(StockpotRecipe recipe) {
        return new StockpotVisuals(
                recipe.cookingTexture(),
                recipe.finishedTexture(),
                recipe.cookingBubbleColor(),
                recipe.finishedBubbleColor()
        );
    }
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, StockpotVisuals> STREAM_CODEC = StreamCodec.composite(
            Identifier.STREAM_CODEC, StockpotVisuals::cookingTexture,
            Identifier.STREAM_CODEC, StockpotVisuals::finishedTexture,
