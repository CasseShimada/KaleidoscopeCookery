...
public class FlexStockpotRecipeCategory implements IRecipeCategory<RecipeHolder<FlexStockpotRecipe>> {
    public static final IRecipeHolderType<FlexStockpotRecipe> TYPE =
            IRecipeHolderType.create(Identifier.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "flex_stockpot"));
    ...
    @Override
    public void draw(RecipeHolder<FlexStockpotRecipe> holder, IRecipeSlotsView recipeSlotsView,
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, RecipeHolder<FlexStockpotRecipe> holder, IFocusGroup focuses) {
        ...
        if (soupBase == null) {
            KaleidoscopeCookery.LOGGER.warn("Skipping missing soup base {} in JEI flex stockpot recipe {}",
    ...
    @Override
    public @NotNull IRecipeType<RecipeHolder<FlexStockpotRecipe>> getRecipeType() {
        return TYPE;
    }
